Algoritmo Ejercicio10
	//Un maestro desea concoer el porcentaje de hombres y mujeres que hay en un grupo de estudiantes 
	//Para ello se ingresa el numero de hombres y de mujeres del grupo. Mostrar por pantalla el
